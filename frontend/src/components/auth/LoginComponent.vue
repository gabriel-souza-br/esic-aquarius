        ...
        <div class="row">
          <q-card square class="shadow-24" style="width: 400px; height: 540px">
            ...
            <q-card-section>
              ...
              >
                <q-tooltip> Criar novo Cadastro </q-tooltip>
              </q-fab>
...
export default {
  ...
  methods: {
    ...
    short(val) {
      return (val && val.length >= 8) || "O campo deve ter 8 caracteres ou mais";
    },
    isEmail(val) {
      const emailPattern =
    ...
    switchTypeForm() {
      ...
      this.title = this.register ? "Novo Cadastro" : "Login";
      this.btnLabel = this.register ? "Cadastrar" : "Enviar";
    },
    switchVisibility() {
